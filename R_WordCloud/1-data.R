...
##my code arranges the data using filter and select functions to get names of colleges from dataset df where grad rate is above 80 and arrange them in descending order. 
...
## my code groups data from datatset df & college by parameter private & the displays the summary w.r.t to max & min Outstate tuition.
dfx <- group_by(df,Private)
